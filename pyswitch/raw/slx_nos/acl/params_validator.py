...
def validate_params_nos_create_acl(**parameters):
...
def validate_params_nos_delete_acl(**parameters):
...
def validate_params_nos_delete_ipv4_rule_acl(**parameters):
...
def validate_params_nos_delete_ipv6_rule_acl(**parameters):
...
def validate_params_slx_create_acl(**parameters):
...
def validate_params_slx_delete_acl(**parameters):
...
def validate_params_slx_delete_ipv4_rule_acl(**parameters):
...
def validate_params_slx_delete_ipv6_rule_acl(**parameters):
...
# MLX validation code comes here
