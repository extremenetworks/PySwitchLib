...
class TestVlan(unittest.TestCase):
    ...
    def setUp(self):
        self.nos = pyswitchlib.asset.Asset(ip_addr='10.24.81.125', auth=('admin', 'password'), fw_ver='nos7.0.1')
    ...
    def test_vlan_update(self):
       pprint(self.nos.vlan_update(vlan=10, description='this_is_a_test_for_vlan_10'))
