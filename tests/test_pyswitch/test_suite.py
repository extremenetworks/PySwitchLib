...
if __name__ == '__main__':
    from test.test_pyswitch.test_interface_OverlayGateway import InterfaceOverlayGatewayTestCase
    from test.test_pyswitch.test_interface_vrf import InterfaceVRFTestCase
    from test.test_pyswitch.test_interface_pvlan import InterfacePrivateVlanTestCase
    from test.test_pyswitch.test_interface_evpn import InterfaceEVPNTestCase
    from test.test_pyswitch.test_interface_virtual_port import InterfaceVirtualPortTestCase
    from test.test_pyswitch.test_interface_port_channel import InterfacePortChannelCase
    from test.test_pyswitch.test_interface_SwitchPort import InterfaceSwitchPort
    ...
    ovg = unittest.TestLoader().loadTestsFromTestCase(InterfaceOverlayGatewayTestCase)
    pvlan = unittest.TestLoader().loadTestsFromTestCase(InterfacePrivateVlanTestCase)
    evpn = unittest.TestLoader().loadTestsFromTestCase(InterfaceEVPNTestCase)
    generic = unittest.TestLoader().loadTestsFromTestCase(InterfaceGenericCase)
    vp = unittest.TestLoader().loadTestsFromTestCase(InterfaceVirtualPortTestCase)
    portChannel = unittest.TestLoader().loadTestsFromTestCase(InterfacePortChannelCase)
