...
def test_vrrpe_vip(asset):
    ...
    asset.interface_ve_ip_address_create(ve='78', address=('9.9.19.1/24', False, False, False))
    asset.interface_ve_vrrp_group_create(vrrp=('3', '3'), ve='78')
    print asset.interface_ve_vrrp_group_virtual_ip_create(vrrp=('3', '3'), ve='78', virtual_ip='9.9.19.2')
